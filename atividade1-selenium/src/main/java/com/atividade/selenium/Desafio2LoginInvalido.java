...
public class Desafio2LoginInvalido {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            inputUsuario.sendKeys("pessoa");
            System.out.println("3 - Campo 'Usuário' preenchido com: pessoa");

            WebElement inputSenha = driver.findElement(By.id("password"));
            inputSenha.sendKeys("456");
            System.out.println("4 - Campo 'Senha' preenchido com: 456");
            ...
            File destino = new File("screenshot-erro.png");
            Files.copy(imagem.toPath(), destino.toPath(), StandardCopyOption.REPLACE_EXISTING);
            System.out.println("8 - Screenshot capturado: screenshot-erro.png");
